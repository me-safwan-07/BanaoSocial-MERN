...
const MenubarSubContent = React.forwardRef<HTMLButtonElement, MenubarProps>(({ className, ...props }) => (
...
const MenubarContent = React.forwardRef<HTMLDivElement, MenubarProps>(
...
const MenubarSeparator = React.forwardRef<HTMLDivElement, MenubarProps>(({ className, ...props }, ref) => (
